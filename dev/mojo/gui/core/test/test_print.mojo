...
def test_print_int32(w: Pointer[WasmInstance, MutUntrackedOrigin]) raises:
    w[].call_void("print_int32", no_args())


def test_print_int64(w: Pointer[WasmInstance, MutUntrackedOrigin]) raises:
    w[].call_void("print_int64", no_args())


def test_print_float32(w: Pointer[WasmInstance, MutUntrackedOrigin]) raises:
    w[].call_void("print_float32", no_args())


def test_print_float64(w: Pointer[WasmInstance, MutUntrackedOrigin]) raises:
