...
@export
def signal_create_string(rt_ptr: Int64, initial: String) -> Int64:
...
@export
def signal_peek_string(rt_ptr: Int64, string_key: Int32) -> String:
...
@export
def signal_string_count(rt_ptr: Int64) -> Int32:
...
@export
def scope_create(rt_ptr: Int64, height: Int32, parent_id: Int32) -> Int32:
...
@export
def scope_hook_tag_at(rt_ptr: Int64, id: Int32, index: Int32) -> Int32:
...
@export
def scope_begin_render(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def hook_use_signal_i32(rt_ptr: Int64, initial: Int32) -> Int32:
...
@export
def hook_use_memo_i32(rt_ptr: Int64, initial: Int32) -> Int32:
...
@export
def hook_use_effect(rt_ptr: Int64) -> Int32:
...
@export
def scope_is_first_render(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def tmpl_builder_push_text(ptr: Int64, text: String, parent: Int32) -> Int32:
...
@export
def tmpl_node_tag(rt_ptr: Int64, tmpl_id: Int32, node_idx: Int32) -> Int32:
...
@export
def tmpl_attr_total_count(rt_ptr: Int64, tmpl_id: Int32) -> Int32:
...
@export
def tmpl_attr_kind(rt_ptr: Int64, tmpl_id: Int32, attr_idx: Int32) -> Int32:
...
@export
def tmpl_dynamic_node_count(rt_ptr: Int64, tmpl_id: Int32) -> Int32:
...
@export
def tmpl_dynamic_text_count(rt_ptr: Int64, tmpl_id: Int32) -> Int32:
...
@export
def tmpl_dynamic_attr_count(rt_ptr: Int64, tmpl_id: Int32) -> Int32:
...
@export
def tmpl_static_attr_count(rt_ptr: Int64, tmpl_id: Int32) -> Int32:
...
@export
def tmpl_contains_name(rt_ptr: Int64, name: String) -> Int32:
...
@export
def tmpl_find_by_name(rt_ptr: Int64, name: String) -> Int32:
...
@export
def tmpl_node_text(rt_ptr: Int64, tmpl_id: Int32, node_idx: Int32) -> String:
...
@export
def tmpl_attr_name(rt_ptr: Int64, tmpl_id: Int32, attr_idx: Int32) -> String:
...
@export
def tmpl_attr_value(rt_ptr: Int64, tmpl_id: Int32, attr_idx: Int32) -> String:
...
@export
def vnode_push_text(store_ptr: Int64, text: String) -> Int32:
...
@export
def vnode_push_placeholder(store_ptr: Int64, element_id: Int32) -> Int32:
...
@export
def vnode_dynamic_attr_count(store_ptr: Int64, index: Int32) -> Int32:
...
@export
def vnode_fragment_child_count(store_ptr: Int64, index: Int32) -> Int32:
...
@export
def vnode_push_dynamic_placeholder(store_ptr: Int64, vnode_index: Int32):
...
@export
def vnode_store_clear(store_ptr: Int64):
...
@export
def signal_iadd_i32(rt_ptr: Int64, key: Int32, rhs: Int32):
...
@export
def signal_isub_i32(rt_ptr: Int64, key: Int32, rhs: Int32):
...
@export
def vnode_root_id_count(store_ptr: Int64, index: Int32) -> Int32:
...
@export
def vnode_get_root_id(store_ptr: Int64, index: Int32, pos: Int32) -> Int32:
...
@export
def vnode_dyn_node_id_count(store_ptr: Int64, index: Int32) -> Int32:
...
@export
def vnode_get_dyn_node_id(store_ptr: Int64, index: Int32, pos: Int32) -> Int32:
...
@export
def vnode_dyn_attr_id_count(store_ptr: Int64, index: Int32) -> Int32:
...
@export
def vnode_get_dyn_attr_id(store_ptr: Int64, index: Int32, pos: Int32) -> Int32:
...
@export
def vnode_is_mounted(store_ptr: Int64, index: Int32) -> Int32:
...
@export
def mutation_buf_alloc(capacity: Int32) -> Int64:
...
@export
def mutation_buf_free(ptr: Int64):
...
@export
def debug_ptr_roundtrip(ptr: Int64) -> Int64:
    """Check that _as_ptr round-trips correctly."""
    return _to_i64(_get[UInt8](ptr))


@export
def debug_write_byte(ptr: Int64, off: Int32, val: Int32) -> Int32:
...
@export
def debug_read_byte(ptr: Int64, off: Int32) -> Int32:
...
@export
def write_op_end(buf: Int64, off: Int32) -> Int32:
...
@export
def write_op_create_placeholder(buf: Int64, off: Int32, id: Int32) -> Int32:
    var w = _writer(buf, off)
...
@export
def write_op_replace_with(buf: Int64, off: Int32, id: Int32, m: Int32) -> Int32:
    var w = _writer(buf, off)
...
@export
def write_op_insert_after(buf: Int64, off: Int32, id: Int32, m: Int32) -> Int32:
    var w = _writer(buf, off)
...
@export
def write_op_remove(buf: Int64, off: Int32, id: Int32) -> Int32:
    var w = _writer(buf, off)
    w.remove(UInt32(id))
    return Int32(w.offset)
...
@export
def write_op_push_root(buf: Int64, off: Int32, id: Int32) -> Int32:
    var w = _writer(buf, off)
...
@export
def write_op_set_text(buf: Int64, off: Int32, id: Int32, text: String) -> Int32:
    var w = _writer(buf, off)
...
@export
def write_test_sequence(buf: Int64) -> Int32:
...
@export
def handler_operand(rt_ptr: Int64, handler_id: Int32) -> Int32:
...
@export
def runtime_drain_dirty(rt_ptr: Int64) -> Int32:
...
@export
def ctx_provide(rt_ptr: Int64, scope_id: Int32, key: Int32, value: Int32):
...
@export
def ctx_consume(rt_ptr: Int64, scope_id: Int32, key: Int32) -> Int32:
...
@export
def ctx_consume_found(rt_ptr: Int64, scope_id: Int32, key: Int32) -> Int32:
...
@export
def ctx_has_local(rt_ptr: Int64, scope_id: Int32, key: Int32) -> Int32:
...
@export
def ctx_count(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def ctx_remove(rt_ptr: Int64, scope_id: Int32, key: Int32) -> Int32:
...
@export
def err_set_boundary(rt_ptr: Int64, scope_id: Int32, enabled: Int32):
...
@export
def err_is_boundary(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def err_find_boundary(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def err_propagate(rt_ptr: Int64, scope_id: Int32, message: String) -> Int32:
...
@export
def suspense_set_boundary(rt_ptr: Int64, scope_id: Int32, enabled: Int32):
...
@export
def suspense_is_boundary(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def suspense_set_pending(rt_ptr: Int64, scope_id: Int32, pending: Int32):
    """Set the pending (async loading) state on a scope."""
    _get[Runtime](rt_ptr)[0].scopes.set_pending(UInt32(scope_id), pending != 0)


@export
def suspense_is_pending(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def suspense_find_boundary(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def suspense_has_pending(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def suspense_resolve(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def memo_create_i32(rt_ptr: Int64, scope_id: Int32, initial: Int32) -> Int32:
...
@export
def memo_bool_create(rt_ptr: Int64, scope_id: Int32, initial: Int32) -> Int32:
...
@export
def memo_did_value_change(rt_ptr: Int64, memo_id: Int32) -> Int32:
...
@export
def runtime_settle_scopes(rt_ptr: Int64):
...
@export
def runtime_clear_changed_signals(rt_ptr: Int64):
...
@export
def runtime_signal_changed(rt_ptr: Int64, key: Int32) -> Int32:
...
@export
def runtime_begin_batch(rt_ptr: Int64):
...
@export
def runtime_end_batch(rt_ptr: Int64):
...
@export
def runtime_is_batching(rt_ptr: Int64) -> Int32:
...
@export
def effect_create(rt_ptr: Int64, scope_id: Int32) -> Int32:
...
@export
def counter_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
...
@export
def counter_decr_handler(app_ptr: Int64) -> Int32:
...
@export
def todo_destroy(app_ptr: Int64):
    """Destroy the todo app and free all resources."""
    todo_app_destroy(_get[TodoApp](app_ptr))


@export
def todo_rebuild(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
...
@export
def todo_add_item(app_ptr: Int64, text: String):
...
@export
def todo_add_handler_id(app_ptr: Int64) -> Int32:
...
@export
def todo_enter_handler_id(app_ptr: Int64) -> Int32:
...
@export
def todo_remove_item(app_ptr: Int64, item_id: Int32):
    """Remove an item by its ID."""
    _get[TodoApp](app_ptr)[0].remove_item(item_id)


@export
def todo_toggle_item(app_ptr: Int64, item_id: Int32):
    """Toggle an item's completed status."""
    _get[TodoApp](app_ptr)[0].toggle_item(item_id)


@export
def todo_set_input(app_ptr: Int64, text: String):
...
@export
def todo_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Flush pending updates.  Returns mutation byte length, or 0 if nothing dirty.
    """
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def todo_input_version(app_ptr: Int64) -> Int32:
...
@export
def todo_input_is_empty(app_ptr: Int64) -> Int32:
...
@export
def todo_handler_action(app_ptr: Int64, handler_id: Int32) -> Int32:
...
@export
def todo_handler_action_data(app_ptr: Int64, handler_id: Int32) -> Int32:
...
@export
def bench_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Flush pending updates.  Returns mutation byte length, or 0 if nothing dirty.
    """
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def bench_handler_map_count(app_ptr: Int64) -> Int32:
...
@export
def bench_handler_id_at(app_ptr: Int64, index: Int32) -> Int32:
...
@export
def bench_status_text(app_ptr: Int64) -> String:
...
@export
def bench_op_name(app_ptr: Int64) -> String:
...
@export
def bench_timing_text(app_ptr: Int64) -> String:
...
@export
def bench_row_count_text(app_ptr: Int64) -> String:
...
@export
def mem_test_signal_cycle(rt_ptr: Int64, count: Int32) -> Int32:
...
@export
def mem_test_scope_cycle(rt_ptr: Int64, count: Int32) -> Int32:
...
@export
def mem_test_rapid_writes(rt_ptr: Int64, key: Int32, count: Int32) -> Int32:
...
@export
def scheduler_clear(sched_ptr: Int64):
...
@export
def shell_destroy(shell_ptr: Int64):
...
@export
def shell_create_signal_i32(shell_ptr: Int64, initial: Int32) -> Int32:
...
@export
def shell_memo_begin_compute(shell_ptr: Int64, memo_id: Int32):
    """Begin memo computation via the AppShell."""
    _get[AppShell](shell_ptr)[0].memo_begin_compute(UInt32(memo_id))


@export
def shell_memo_end_compute_i32(shell_ptr: Int64, memo_id: Int32, value: Int32):
...
@export
def shell_memo_read_i32(shell_ptr: Int64, memo_id: Int32) -> Int32:
    """Read a memo's cached value via the AppShell."""
    return _get[AppShell](shell_ptr)[0].memo_read_i32(UInt32(memo_id))


@export
def shell_memo_is_dirty(shell_ptr: Int64, memo_id: Int32) -> Int32:
    """Check whether the memo needs recomputation.  Returns 1 or 0."""
    return _b2i(_get[AppShell](shell_ptr)[0].memo_is_dirty(UInt32(memo_id)))


@export
def shell_use_memo_i32(shell_ptr: Int64, initial: Int32) -> Int32:
...
@export
def shell_rt_ptr(shell_ptr: Int64) -> Int64:
...
@export
def dsl_to_template(node_ptr: Int64, name: String, rt_ptr: Int64) -> Int32:
...
@export
def dsl_vb_create(tmpl_id: Int32, store_ptr: Int64) -> Int64:
...
@export
def dsl_vb_create_keyed(tmpl_id: Int32, key: String, store_ptr: Int64) -> Int64:
...
@export
def dsl_test_text_node() -> Int32:
    return _dsl_test_text_node()


@export
def dsl_test_dyn_text_node() -> Int32:
    return _dsl_test_dyn_text_node()


@export
def dsl_test_dyn_node_slot() -> Int32:
    return _dsl_test_dyn_node_slot()


@export
def dsl_test_static_attr() -> Int32:
    return _dsl_test_static_attr()


@export
def dsl_test_dyn_attr() -> Int32:
    return _dsl_test_dyn_attr()


@export
def dsl_test_empty_element() -> Int32:
    return _dsl_test_empty_element()


@export
def dsl_test_element_with_children() -> Int32:
    return _dsl_test_element_with_children()


@export
def dsl_test_element_with_attrs() -> Int32:
    return _dsl_test_element_with_attrs()


@export
def dsl_test_element_mixed() -> Int32:
    return _dsl_test_element_mixed()


@export
def dsl_test_nested_elements() -> Int32:
    return _dsl_test_nested_elements()


@export
def dsl_test_counter_template() -> Int32:
    return _dsl_test_counter_template()


@export
def dsl_test_to_template_simple() -> Int32:
    return _dsl_test_to_template_simple()


@export
def dsl_test_to_template_attrs() -> Int32:
    return _dsl_test_to_template_attrs()


@export
def dsl_test_to_template_multi_root() -> Int32:
    return _dsl_test_to_template_multi_root()


@export
def dsl_test_vnode_builder() -> Int32:
    return _dsl_test_vnode_builder()


@export
def dsl_test_vnode_builder_keyed() -> Int32:
    return _dsl_test_vnode_builder_keyed()


@export
def dsl_test_all_tag_helpers() -> Int32:
    return _dsl_test_all_tag_helpers()


@export
def dsl_test_count_utilities() -> Int32:
    return _dsl_test_count_utilities()


@export
def dsl_test_template_equivalence() -> Int32:
...
@export
def dsl_test_oninput_set_string_node() -> Int32:
    return _dsl_test_oninput_set_string_node()


@export
def dsl_test_onchange_set_string_node() -> Int32:
    return _dsl_test_onchange_set_string_node()


@export
def dsl_test_oninput_in_element() -> Int32:
...
@export
def dsl_test_bind_value_node() -> Int32:
    return _dsl_test_bind_value_node()


@export
def dsl_test_bind_attr_node() -> Int32:
    return _dsl_test_bind_attr_node()


@export
def dsl_test_bind_value_in_element() -> Int32:
    return _dsl_test_bind_value_in_element()


@export
def dsl_test_two_way_binding_element() -> Int32:
    return _dsl_test_two_way_binding_element()


@export
def dsl_test_bind_value_to_template() -> Int32:
    return _dsl_test_bind_value_to_template()


@export
def dsl_test_two_way_to_template() -> Int32:
...
@export
def dsl_test_onclick_custom_node() -> Int32:
    return _dsl_test_onclick_custom_node()


@export
def dsl_test_onclick_custom_in_element() -> Int32:
    return _dsl_test_onclick_custom_in_element()


@export
def dsl_test_onclick_custom_with_binding() -> Int32:
    return _dsl_test_onclick_custom_with_binding()


@export
def dsl_test_onkeydown_enter_custom_node() -> Int32:
    return _dsl_test_onkeydown_enter_custom_node()


@export
def dsl_test_onkeydown_enter_custom_in_element() -> Int32:
    return _dsl_test_onkeydown_enter_custom_in_element()


@export
def dsl_test_onkeydown_enter_custom_with_binding() -> Int32:
...
@export
def add_int32(x: Int32, y: Int32) -> Int32:
    return x + y


@export
def add_int64(x: Int64, y: Int64) -> Int64:
    return x + y


@export
def add_float32(x: Float32, y: Float32) -> Float32:
    return x + y


@export
def add_float64(x: Float64, y: Float64) -> Float64:
    return x + y
...
@export
def sub_int32(x: Int32, y: Int32) -> Int32:
    return x - y


@export
def sub_int64(x: Int64, y: Int64) -> Int64:
    return x - y


@export
def sub_float32(x: Float32, y: Float32) -> Float32:
    return x - y


@export
def sub_float64(x: Float64, y: Float64) -> Float64:
    return x - y
...
@export
def mul_int32(x: Int32, y: Int32) -> Int32:
    return x * y


@export
def mul_int64(x: Int64, y: Int64) -> Int64:
    return x * y


@export
def mul_float32(x: Float32, y: Float32) -> Float32:
    return x * y


@export
def mul_float64(x: Float64, y: Float64) -> Float64:
    return x * y
...
@export
def div_int32(x: Int32, y: Int32) -> Int32:
    return x // y


@export
def div_int64(x: Int64, y: Int64) -> Int64:
    return x // y


@export
def div_float32(x: Float32, y: Float32) -> Float32:
    return x / y


@export
def div_float64(x: Float64, y: Float64) -> Float64:
    return x / y
...
@export
def mod_int32(x: Int32, y: Int32) -> Int32:
    return x % y


@export
def mod_int64(x: Int64, y: Int64) -> Int64:
    return x % y
...
@export
def pow_int32(x: Int32) -> Int32:
    return x**x


@export
def pow_int64(x: Int64) -> Int64:
    return x**x


@export
def pow_float32(x: Float32) -> Float32:
    return x**x


@export
def pow_float64(x: Float64) -> Float64:
    return x**x
...
@export
def neg_int32(x: Int32) -> Int32:
    return -x


@export
def neg_int64(x: Int64) -> Int64:
    return -x


@export
def neg_float32(x: Float32) -> Float32:
    return -x


@export
def neg_float64(x: Float64) -> Float64:
    return -x
...
@export
def abs_float32(x: Float32) -> Float32:
    if x < 0:
        return -x
    return x
...
@export
def abs_float64(x: Float64) -> Float64:
    if x < 0:
        return -x
    return x
...
@export
def min_int32(x: Int32, y: Int32) -> Int32:
    if x < y:
        return x
    return y
...
@export
def max_int32(x: Int32, y: Int32) -> Int32:
    if x > y:
        return x
    return y
...
@export
def min_int64(x: Int64, y: Int64) -> Int64:
    if x < y:
        return x
    return y
...
@export
def max_int64(x: Int64, y: Int64) -> Int64:
    if x > y:
        return x
    return y
...
@export
def min_float64(x: Float64, y: Float64) -> Float64:
    if x < y:
        return x
    return y
...
@export
def max_float64(x: Float64, y: Float64) -> Float64:
    if x > y:
        return x
    return y
...
@export
def clamp_int32(x: Int32, lo: Int32, hi: Int32) -> Int32:
    if x < lo:
        return lo
    if x > hi:
        return hi
...
@export
def clamp_float64(x: Float64, lo: Float64, hi: Float64) -> Float64:
    if x < lo:
        return lo
    if x > hi:
        return hi
...
@export
def bitand_int32(x: Int32, y: Int32) -> Int32:
    return x & y


@export
def bitor_int32(x: Int32, y: Int32) -> Int32:
    return x | y


@export
def bitxor_int32(x: Int32, y: Int32) -> Int32:
    return x ^ y


@export
def bitnot_int32(x: Int32) -> Int32:
    return ~x


@export
def shl_int32(x: Int32, y: Int32) -> Int32:
    return x << y


@export
def shr_int32(x: Int32, y: Int32) -> Int32:
    return x >> y
...
@export
def eq_int32(x: Int32, y: Int32) -> Bool:
    return x == y


@export
def ne_int32(x: Int32, y: Int32) -> Bool:
    return x != y


@export
def lt_int32(x: Int32, y: Int32) -> Bool:
    return x < y


@export
def le_int32(x: Int32, y: Int32) -> Bool:
    return x <= y


@export
def gt_int32(x: Int32, y: Int32) -> Bool:
    return x > y


@export
def ge_int32(x: Int32, y: Int32) -> Bool:
    return x >= y
...
@export
def factorial_int32(n: Int32) -> Int32:
    if n <= 1:
        return 1
    var result: Int32 = 1
...
@export
def factorial_int64(n: Int64) -> Int64:
    if n <= 1:
        return 1
    var result: Int64 = 1
    for i in range(2, Int(n) + 1):
...
@export
def gcd_int32(x: Int32, y: Int32) -> Int32:
    var a = x
    var b = y
    if a < 0:
        a = -a
...
@export
def identity_int32(x: Int32) -> Int32:
    return x


@export
def identity_int64(x: Int64) -> Int64:
    return x


@export
def identity_float32(x: Float32) -> Float32:
    return x


@export
def identity_float64(x: Float64) -> Float64:
    return x
...
@export
def print_static_string():
    print("print-static-string")


@export
def print_input_string(input: String):
    print(input)
...
@export
def return_input_string(x: String) -> String:
    return x


@export
def return_static_string() -> String:
    return "return-static-string"


@export
def string_length(x: String) -> Int64:
    return Int64(x.byte_length())


@export
def string_concat(x: String, y: String) -> String:
    return x + y


@export
def string_repeat(x: String, n: Int32) -> String:
    var result = String("")
...
@export
def cc_destroy(app_ptr: Int64):
    """Destroy the child-counter app."""
    _cc_destroy(_get[ChildCounterApp](app_ptr))


@export
def cc_rebuild(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
...
@export
def cc_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
...
@export
def cc_decr_handler(app_ptr: Int64) -> Int32:
...
@export
def mv_destroy(app_ptr: Int64):
    """Destroy the multi-view app."""
    multi_view_app_destroy(_get[MultiViewApp](app_ptr))


@export
def mv_rebuild(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Initial render (mount).  Returns mutation byte length."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def mv_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Flush pending updates.  Returns mutation byte length, or 0."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def mv_navigate(app_ptr: Int64, path: String) -> Int32:
...
@export
def mv_cond_mounted(app_ptr: Int64) -> Int32:
...
@export
def cta_consume_context(app_ptr: Int64, key: Int32) -> Int32:
...
@export
def cta_has_context(app_ptr: Int64, key: Int32) -> Int32:
...
@export
def cta_consume_from_child(app_ptr: Int64, key: Int32) -> Int32:
...
@export
def cta_consume_found_from_child(app_ptr: Int64, key: Int32) -> Int32:
...
@export
def cta_provide_signal_i32(app_ptr: Int64, ctx_key: Int32):
...
@export
def cta_consume_signal_i32_from_child(app_ptr: Int64, ctx_key: Int32) -> Int32:
...
@export
def cta_write_signal_via_child(app_ptr: Int64, ctx_key: Int32, value: Int32):
...
@export
def cct_destroy(app_ptr: Int64):
    """Destroy the child-context test app."""
    _cct_destroy(_get[ChildContextTestApp](app_ptr))


@export
def cct_rebuild(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Initial render (mount).  Returns mutation byte length."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def cct_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Flush pending updates.  Returns mutation byte length, or 0."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def cct_has_dirty(app_ptr: Int64) -> Int32:
...
@export
def cct_handler_count(app_ptr: Int64) -> Int32:
    """Return the total number of registered handlers."""
    return Int32(_get[ChildContextTestApp](app_ptr)[0].ctx.handler_count())


@export
def cct_incr_handler(app_ptr: Int64) -> Int32:
    """Return the increment handler ID (parent view_events[0])."""
...
@export
def cct_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def pc_destroy(app_ptr: Int64):
    """Destroy the props-counter app."""
    _pc_destroy(_get[PropsCounterApp](app_ptr))


@export
def pc_rebuild(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Initial render (mount).  Returns mutation byte length."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def pc_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Flush pending updates.  Returns mutation byte length, or 0."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def pc_child_is_mounted(app_ptr: Int64) -> Int32:
    """Return 1 if child is mounted, 0 otherwise."""
    return _b2i(
...
@export
def pc_child_is_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if child scope is dirty, 0 otherwise."""
    return _b2i(_get[PropsCounterApp](app_ptr)[0].display.child_ctx.is_dirty())


@export
def pc_parent_is_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if parent scope is in the dirty queue, 0 otherwise."""
...
@export
def pc_has_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if any scope is dirty, 0 otherwise."""
    var app = _get[PropsCounterApp](app_ptr)
    if app[0].ctx.has_dirty():
        return 1
...
@export
def pc_handler_count(app_ptr: Int64) -> Int32:
    """Return the total number of registered handlers."""
    return Int32(_get[PropsCounterApp](app_ptr)[0].ctx.handler_count())


@export
def pc_incr_handler(app_ptr: Int64) -> Int32:
    """Return the increment handler ID (parent view_events[0])."""
...
@export
def pc_decr_handler(app_ptr: Int64) -> Int32:
    """Return the decrement handler ID (parent view_events[1])."""
    var events = _get[PropsCounterApp](app_ptr)[0].ctx.view_events()
    if len(events) > 1:
        return Int32(events[1].handler_id)
...
@export
def pc_toggle_handler(app_ptr: Int64) -> Int32:
...
@export
def pc_child_has_rendered(app_ptr: Int64) -> Int32:
    """Return 1 if child has rendered, 0 otherwise."""
    return _b2i(
...
@export
def pc_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def tc_destroy(app_ptr: Int64):
    """Destroy the theme-counter app."""
    _tc_destroy(_get[ThemeCounterApp](app_ptr))


@export
def tc_rebuild(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Initial render (mount).  Returns mutation byte length."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def tc_flush(app_ptr: Int64, buf_ptr: Int64, capacity: Int32) -> Int32:
    """Flush pending updates.  Returns mutation byte length, or 0."""
    var writer_ptr = _alloc_writer(buf_ptr, capacity)
...
@export
def tc_summary_scope_id(app_ptr: Int64) -> Int32:
...
@export
def tc_parent_scope_id(app_ptr: Int64) -> Int32:
    """Return the parent scope ID."""
    return Int32(_get[ThemeCounterApp](app_ptr)[0].ctx.scope_id)


@export
def tc_counter_is_mounted(app_ptr: Int64) -> Int32:
...
@export
def tc_summary_is_mounted(app_ptr: Int64) -> Int32:
...
@export
def tc_counter_is_dirty(app_ptr: Int64) -> Int32:
...
@export
def tc_summary_is_dirty(app_ptr: Int64) -> Int32:
...
@export
def tc_parent_is_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if parent scope is in the dirty queue, 0 otherwise."""
...
@export
def tc_has_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if any scope is dirty, 0 otherwise."""
    var app = _get[ThemeCounterApp](app_ptr)
    if app[0].ctx.has_dirty():
        return 1
...
@export
def tc_handler_count(app_ptr: Int64) -> Int32:
    """Return the total number of registered handlers."""
    return Int32(_get[ThemeCounterApp](app_ptr)[0].ctx.handler_count())


@export
def tc_toggle_theme_handler(app_ptr: Int64) -> Int32:
...
@export
def tc_increment_handler(app_ptr: Int64) -> Int32:
...
@export
def tc_reset_handler(app_ptr: Int64) -> Int32:
...
@export
def tc_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def tc_counter_has_rendered(app_ptr: Int64) -> Int32:
...
@export
def tc_summary_has_rendered(app_ptr: Int64) -> Int32:
...
@export
def sc_destroy(app_ptr: Int64):
    """Destroy the safe-counter app."""
    _sc_destroy(_get[SafeCounterApp](app_ptr))


@export
def sc_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
...
@export
def sc_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
...
@export
def sc_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
...
@export
def sc_normal_mounted(app_ptr: Int64) -> Int32:
...
@export
def sc_fallback_mounted(app_ptr: Int64) -> Int32:
...
@export
def sc_normal_has_rendered(app_ptr: Int64) -> Int32:
...
@export
def sc_fallback_has_rendered(app_ptr: Int64) -> Int32:
...
@export
def sc_has_dirty(app_ptr: Int64) -> Int32:
...
@export
def sc_handler_count(app_ptr: Int64) -> Int32:
    """Return the total number of registered handlers."""
    return Int32(_get[SafeCounterApp](app_ptr)[0].ctx.handler_count())


@export
def sc_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def en_destroy(app_ptr: Int64):
    """Destroy the error-nest app."""
    _en_destroy(_get[ErrorNestApp](app_ptr))


@export
def en_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def en_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _en_handle_event(
...
@export
def en_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def en_outer_fallback_mounted(app_ptr: Int64) -> Int32:
...
@export
def en_inner_normal_mounted(app_ptr: Int64) -> Int32:
...
@export
def en_inner_fallback_mounted(app_ptr: Int64) -> Int32:
...
@export
def en_has_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if any scope is dirty."""
...
@export
def en_handler_count(app_ptr: Int64) -> Int32:
    """Return the total number of registered handlers."""
    return Int32(_get[ErrorNestApp](app_ptr)[0].ctx.handler_count())


@export
def en_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def en_inner_fallback_scope_id(app_ptr: Int64) -> Int32:
...
@export
def en_outer_fallback_scope_id(app_ptr: Int64) -> Int32:
...
@export
def dl_destroy(app_ptr: Int64):
    """Destroy the data-loader app."""
    _dl_destroy(_get[DataLoaderApp](app_ptr))


@export
def dl_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def dl_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _dl_handle_event(
...
@export
def dl_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def dl_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def sn_destroy(app_ptr: Int64):
    """Destroy the suspense-nest app."""
    _sn_destroy(_get[SuspenseNestApp](app_ptr))


@export
def sn_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def sn_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _sn_handle_event(
...
@export
def sn_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def sn_outer_skeleton_mounted(app_ptr: Int64) -> Int32:
...
@export
def sn_inner_content_mounted(app_ptr: Int64) -> Int32:
...
@export
def sn_inner_skeleton_mounted(app_ptr: Int64) -> Int32:
...
@export
def sn_has_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if any scope is dirty."""
...
@export
def sn_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def sn_outer_scope_id(app_ptr: Int64) -> Int32:
    """Return the outer (root) scope ID."""
    return Int32(_get[SuspenseNestApp](app_ptr)[0].ctx.scope_id)


@export
def sn_inner_boundary_scope_id(app_ptr: Int64) -> Int32:
...
@export
def sn_inner_content_scope_id(app_ptr: Int64) -> Int32:
...
@export
def sn_inner_skeleton_scope_id(app_ptr: Int64) -> Int32:
...
@export
def sn_outer_skeleton_scope_id(app_ptr: Int64) -> Int32:
...
@export
def ed_destroy(app_ptr: Int64):
    """Destroy the effect-demo app."""
    _ed_destroy(_get[EffectDemoApp](app_ptr))


@export
def ed_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def ed_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _ed_handle_event(
...
@export
def ed_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def ed_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def em_destroy(app_ptr: Int64):
    """Destroy the effect-memo app."""
    _em_destroy(_get[EffectMemoApp](app_ptr))


@export
def em_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def em_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _em_handle_event(
...
@export
def em_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def em_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def mf_destroy(app_ptr: Int64):
    """Destroy the memo-form app."""
    _mf_destroy(_get[MemoFormApp](app_ptr))


@export
def mf_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def mf_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
...
@export
def mf_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def mf_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def mf_memo_count(app_ptr: Int64) -> Int32:
    """Return the number of live memos."""
    return Int32(
...
@export
def mc_destroy(app_ptr: Int64):
    """Destroy the memo-chain app."""
    _mc_destroy(_get[MemoChainApp](app_ptr))


@export
def mc_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def mc_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _mc_handle_event(
...
@export
def mc_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def mc_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def mc_memo_count(app_ptr: Int64) -> Int32:
    """Return the number of live memos."""
    return Int32(
...
@export
def eq_destroy(app_ptr: Int64):
    """Destroy the equality-demo app."""
    _eq_destroy(_get[EqualityDemoApp](app_ptr))


@export
def eq_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
...
@export
def eq_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
...
@export
def eq_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
...
@export
def eq_label_changed(app_ptr: Int64) -> Int32:
...
@export
def eq_scope_count(app_ptr: Int64) -> Int32:
    """Return the number of live scopes."""
    return Int32(
...
@export
def eq_memo_count(app_ptr: Int64) -> Int32:
    """Return the number of live memos."""
    return Int32(
...
@export
def bd_destroy(app_ptr: Int64):
    """Destroy the batch-demo app."""
    _bd_destroy(_get[BatchDemoApp](app_ptr))


@export
def bd_rebuild(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Initial mount.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def bd_handle_event(app_ptr: Int64, hid: Int32, evt: Int32) -> Int32:
    """Dispatch an event.  Returns 1 if handled, 0 otherwise."""
    return _b2i(
        _bd_handle_event(
...
@export
def bd_flush(app_ptr: Int64, buf_ptr: Int64, cap: Int32) -> Int32:
    """Flush pending updates.  Returns mutation buffer length."""
    var writer_ptr = _alloc_writer(buf_ptr, cap)
...
@export
def bd_set_names(app_ptr: Int64, first: String, last: String):
...
@export
def bd_has_dirty(app_ptr: Int64) -> Int32:
    """Return 1 if any scope is dirty."""
...
@export
def bd_memo_count(app_ptr: Int64) -> Int32:
    """Return the number of live memos."""
    return Int32(
