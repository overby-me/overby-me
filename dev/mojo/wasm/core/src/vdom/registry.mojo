...
struct TemplateRegistry(Movable):
    ...
    def __init__(out self, *, deinit move: Self):
        self._templates = move._templates^
        self._names = move._names^
        self._count = move._count

    # ── Register ─────────────────────────────────────────────────────

    def register(mut self, var template: Template) -> UInt32:
    ...
    def find_by_name(self, name: String) -> Int:
