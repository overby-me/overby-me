...
const EN_JSON: &str = r#"{
    ...
    "auth": {
        ...
        "verificationTooSoon": "A verification email was just sent. Wait a few minutes before asking for another, and check your spam folder.",
    ...
    "layout": {
        ...
        "rememberEmailAtproto": "Your invitations find you by the email address on your account, so it should be the one you are registered with at RU.",
        "noInvitationsHintAtproto": "If no invitations appear, the email address on your account is most likely not the one Radikal Ungdom has for you. Ask whoever runs your group for a claim link.",
        "newGroup": "New group",
        "newEvent": "New event",
        "parentGroup": "Group",
        "chooseGroup": "Choose a group",
        "needGroupFirst": "An event belongs to a group, and you have none yet. Create a group first, then add the event inside it.",
        "createFailed": "Could not create it. Try a different name.",
        "showAll": "Show all ({{count}})",
        "showMore": "Show more",
        "showLess": "Show less",
        "openToAll": "Open to everyone",
        "openToAllHint": "Everything else here is for members. Log in to see the groups and events you belong to.",
        "openToAllEmpty": "Nothing is open to visitors right now.",
        "groups": "Groups",
        "sites": "Sites",
    ...
    "pixel": {
        ...
        "zoomIn": "Closer",
        "zoomOut": "Further out",
        "lock": "Lock, so no more paint",
        "unlock": "Open for painting",
        "canvasWidth": "Width",
        "canvasHeight": "Height",
        "colour": "Colour",
    ...
    "folder": {
        ...
        "lockPlace": "Lock the whole place",
        "unlockPlace": "Unlock the whole place",
        "lockPlaceExplain": "Every folder, position and resolution here stops taking anything new, however deep it sits. Owners can still add, and everyone can still comment. You can unlock it again.",
        "unlockPlaceExplain": "Every folder, position and resolution here can take new content again.",
        "placeChanged": "{n} changed",
    ...
    "vote": {
        ...
        "ballotCounted": "Your ballot is on the board as you cast it (entry {{position}}).",
        "ballotDifferent": "Your ballot is on the board with other choices than you cast. Tell the chair, and keep this device: it holds the proof.",
        "ballotMissing": "Your ballot is not on the board.",
        "recount": "Count the ballots again",
        "recounting": "Counting…",
        "recountMatches": "Counted again here: {{count}} ballots, and they add up to the announced result and its signed close-out.",
        "recountDisputed": "Counted again here, and it does not add up:",
        "yourVote": "Your vote",
        "youCastIt": "You cast it yourself.",
        "givenTo": "Given to {{name}}, who casts it for you.",
        "takeBack": "Take it back",
        "giveTo": "Give my vote to someone",
        "searchMember": "Search for a member",
        "youCarry": "You also cast the vote of: {{names}}.",
        "delegationNote": "This applies to polls opened from now on. A poll that is already open stays as it was.",
    ...
    "perm": {
        "type": "Type",
        "openToAll": "Open to everyone",
        "openToAllOn": "Anyone can read this place without an account.",
        "openToAllOff": "Only members can read this place.",
        "openConfirm": "Open it",
        "openWarning": "Anyone with the address will be able to read this place and everything in it, without logging in. Votes and polls stay closed. You can close it again, but a page that has been read cannot be unread.",
        "nowPublic": "Open to everyone",
    ...
    "poll": {
        ...
        "hideResult": "Hide running tally",
        "hideResultHint": "Only you see the counts while voting is open. Votes still carry the voter's name.",
        "secretBallot": "Secret ballot",
        "secretBallotHint": "Casts are recorded without the voter, so nobody can trace one afterwards.",
        "newPoll": "New poll",
    ...
    "invite": {
        ...
        "joinHeadline": "Join {{name}}?",
        "joinBody": "You have been invited to {{name}} but have not joined yet. Join to take part and to be counted as a member here.",
        "join": "Join",
        "notNow": "Not now",
        "invited": "Invited",
        ...
        "someAlreadyInvited": "{{skipped}} were already invited here.",
        "allAlreadyInvited": "Nothing to import: all {{skipped}} were already invited here.",
        "someWithoutEmail": "{{noEmail}} have no email address, so they cannot be invited until one is added.",
        "someMailed": "{{mailed}} are being sent a link to their seat by email.",
        "noRosterRows": "No usable rows found in the file",
    ...
    "file": {
        ...
        "nextPage": "Next page",
        "pageLabel": "Page {{page}}",
        "pdfReflowed": "Reflowed from {{pages}} pages, so the words wrap to this screen rather than to the page. Choose “As printed” to see the pages as they were laid out.",
        ...
        "nativeFailed": "This app could not read that document. Try Microsoft Office or Google Docs above.",
        "gapPartial": "This viewer cannot show:",
        "gapMost": "Much of this file cannot be shown here. It is missing:",
        "gapImages": "images",
        "imageNotDrawable": "This picture cannot be shown here",
        "gapCharts": "charts",
    ...
    "game": {
        ...
        "toastBooks": "Well read: twice the reach",
        ...
        "toastOil": "Oil slick! Steer the other way",
        "toastTruck": "The fossil lobby bolts, spilling oil",
        "toastToll": "Bridge toll paid: -18%",
        "toastTollFree": "EU flag: the toll is waived",
        "toastTollBlocked": "Too flat to pay the toll. Find a battery, or an EU flag",
        "toastTailwind": "Tailwind off the windmills",
        "toastHeadwind": "Headwind: this stretch costs more",
        "raceWon": "Player {{p}} wins the campaign!",
        "raceDraw": "A dead heat",
        "raceScore": "Player 1 hung {{a}} of {{total}}, player 2 hung {{b}}. The race ends when the first car reaches Christiansborg, so arriving early can cost you the posters.",
        "wonTitleLandslide": "Landslide!",
        "wonTitleElected": "Elected!",
        "wonTitleBelow": "Below the threshold",
        "wonLandslide": "{{n}} of {{total}} posters up. Christiansborg celebrates with fireworks!",
...
const DA_JSON: &str = r#"{
    ...
    "auth": {
        ...
        "verificationTooSoon": "Der er lige sendt en verifikationsmail. Vent et par minutter før du beder om en ny, og tjek dit spamfilter.",
    ...
    "layout": {
        ...
        "rememberEmailAtproto": "Dine invitationer finder dig via emailadressen på din konto, så den bør være den du er registreret med i RU.",
        "noInvitationsHintAtproto": "Hvis ingen invitationer dukker op, er emailadressen på din konto sandsynligvis ikke den Radikal Ungdom har på dig. Bed den der styrer din gruppe om et link til din plads.",
        "newGroup": "Ny gruppe",
        "newEvent": "Ny begivenhed",
        "parentGroup": "Gruppe",
        "chooseGroup": "Vælg en gruppe",
        "needGroupFirst": "En begivenhed hører til en gruppe, og du har ingen endnu. Opret først en gruppe, og læg så begivenheden ind i den.",
        "createFailed": "Kunne ikke oprette. Prøv et andet navn.",
        "showAll": "Vis alle ({{count}})",
        "showMore": "Vis mere",
        "showLess": "Vis mindre",
        "openToAll": "Åbent for alle",
        "openToAllHint": "Alt andet her er for medlemmer. Log ind for at se de grupper og begivenheder, du er med i.",
        "openToAllEmpty": "Der er ikke noget åbent for gæster lige nu.",
        "groups": "Grupper",
        "sites": "Websteder",
        "noSites": "Ingen websteder endnu.",
        "newSite": "Nyt websted",
        "events": "Begivenheder",
    ...
    "pixel": {
        ...
        "zoomIn": "T\u00e6ttere p\u00e5",
        "zoomOut": "L\u00e6ngere v\u00e6k",
        "lock": "L\u00e5s, s\u00e5 der ikke males mere",
        "unlock": "\u00c5bn for maling",
        "canvasWidth": "Bredde",
        "canvasHeight": "H\u00f8jde",
        "colour": "Farve",
    ...
    "folder": {
        ...
        "lockPlace": "L\u00e5s hele stedet",
        "unlockPlace": "L\u00e5s hele stedet op",
        "lockPlaceExplain": "Alle mapper, poster og forslag her holder op med at tage imod nyt, uanset hvor dybt de ligger. Ejere kan stadig tilf\u00f8je, og alle kan stadig kommentere. Du kan l\u00e5se op igen.",
        "unlockPlaceExplain": "Alle mapper, poster og forslag her kan tage imod nyt indhold igen.",
        "placeChanged": "{n} \u00e6ndret",
    ...
    "vote": {
        ...
        "ballotCounted": "Din stemmeseddel står på tavlen som du afgav den (nr. {{position}}).",
        "ballotDifferent": "Din stemmeseddel står på tavlen med andre valg end du afgav. Sig det til dirigenten, og behold denne enhed: den har beviset.",
        "ballotMissing": "Din stemmeseddel står ikke på tavlen.",
        "recount": "Tæl stemmesedlerne igen",
        "recounting": "Tæller…",
        "recountMatches": "Talt igen her: {{count}} stemmesedler, og de stemmer med det offentliggjorte resultat og dets underskrevne afslutning.",
        "recountDisputed": "Talt igen her, og det stemmer ikke:",
        "yourVote": "Din stemme",
        "youCastIt": "Du afgiver den selv.",
        "givenTo": "Givet til {{name}}, som afgiver den for dig.",
        "takeBack": "Tag den tilbage",
        "giveTo": "Giv min stemme til en anden",
        "searchMember": "Søg efter et medlem",
        "youCarry": "Du afgiver også stemmen for: {{names}}.",
        "delegationNote": "Det gælder afstemninger der åbnes fra nu af. En afstemning der allerede er åben, forbliver som den var.",
    ...
    "perm": {
        "type": "Type",
        "openToAll": "\u00c5bent for alle",
        "openToAllOn": "Alle kan l\u00e6se dette sted uden en konto.",
        "openToAllOff": "Kun medlemmer kan l\u00e6se dette sted.",
        "openConfirm": "\u00c5bn det",
        "openWarning": "Alle med adressen vil kunne l\u00e6se dette sted og alt i det, uden at logge ind. Afstemninger forbliver lukkede. Du kan lukke det igen, men en side, der er blevet l\u00e6st, kan ikke blive ul\u00e6st.",
        "nowPublic": "\u00c5bent for alle",
        "nowPrivate": "Kun medlemmer",
        "role": "Rolle",
        "insert": "Opret",
        "select": "Vis",
        "delete": "Slet",
    ...
    "poll": {
        ...
        "hideResult": "Skjul løbende optælling",
        "hideResultHint": "Kun du ser optællingen, mens afstemningen er åben. Stemmer bærer stadig vælgerens navn.",
        "secretBallot": "Hemmelig afstemning",
        "secretBallotHint": "Stemmer registreres uden vælgeren, så ingen kan spore dem bagefter.",
    ...
    "invite": {
        ...
        "joinHeadline": "Vil du være med i {{name}}?",
        "joinBody": "Du er inviteret til {{name}}, men er ikke med endnu. Vær med for at deltage og tælle som medlem her.",
        "join": "Vær med",
        "notNow": "Ikke nu",
        "invited": "Inviteret",
        ...
        "someAlreadyInvited": "{{skipped}} var allerede inviteret her.",
        "allAlreadyInvited": "Intet at importere: Alle {{skipped}} var allerede inviteret her.",
        "someWithoutEmail": "{{noEmail}} har ingen emailadresse og kan ikke inviteres, før der er tilføjet en.",
        "someMailed": "{{mailed}} får et link til deres plads på email.",
        "noRosterRows": "Ingen brugbare rækker fundet i filen",
    ...
    "file": {
        ...
        "nextPage": "Næste side",
        "pageLabel": "Side {{page}}",
        "pdfReflowed": "Ombrudt fra {{pages}} sider, så teksten passer til skærmen i stedet for til siden. Vælg “Som trykt” for at se siderne, som de er sat op.",
        ...
        "nativeFailed": "Denne app kunne ikke l\u00e6se dokumentet. Pr\u00f8v Microsoft Office eller Google Docs ovenfor.",
        "gapPartial": "Denne fremviser kan ikke vise:",
        "gapMost": "Meget af denne fil kan ikke vises her. Den mangler:",
        "gapImages": "billeder",
        "imageNotDrawable": "Dette billede kan ikke vises her",
    ...
    "game": {
        ...
        "toastBooks": "Godt belæst: dobbelt rækkevidde",
        ...
        "toastOil": "Oliepøl! Styr den anden vej",
        "toastTruck": "Fossillobbyen stikker af og spilder olie",
        "toastToll": "Brotold betalt: -18 %",
        "toastTollFree": "EU-flag: tolden bortfalder",
        "toastTollBlocked": "For lidt strøm til tolden. Find et batteri eller et EU-flag",
        "toastTailwind": "Medvind fra vindmøllerne",
        "toastHeadwind": "Modvind: Denne strækning koster mere",
        "raceWon": "Spiller {{p}} vinder valgkampen!",
        "raceDraw": "Dødt løb",
        "raceScore": "Spiller 1 hængte {{a}} af {{total}} op, spiller 2 hængte {{b}}. Løbet slutter, når den første bil når Christiansborg, så det kan koste plakater at komme for tidligt frem.",
        "wonTitleLandslide": "Kanonvalg!",
        "wonTitleElected": "Valgt ind!",
        "wonTitleBelow": "Under spærregrænsen",
        "wonLandslide": "{{n}} af {{total}} plakater oppe. Christiansborg fejrer med fyrværkeri!",
