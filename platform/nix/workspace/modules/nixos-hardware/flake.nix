# hardware profiles for machines this tree runs on.
#
...
{
  description = "hardware profiles for machines this tree runs on";
  ...
  outputs = inputs: {
    workspaceModule = {lib, ...}: {
      ...
      key = "nix-workspace/modules/nixos-hardware";
      ...
      inputs.nixos-hardware = lib.mkDefault inputs.nixos-hardware;
    };
  };
}
