...
# Nix derivation. A sibling to platform/nix/config/lib/buck2 (per-action Buck2 builds) and
# platform/nix/config/lib/cargo (per-crate builds); the graph is extracted once with
