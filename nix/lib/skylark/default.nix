...
# convenience, like nix/lib/cargo's cargoLib). The real API lives in
# ./api.nix; Buck2 (nix/lib/buck2) imports it directly by path.
#
# Having a default.nix also makes the nix/lib autoloader import this directory
