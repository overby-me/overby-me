...
#
# Run with: nix build .#checks.x86_64-linux.rust-rung1-resolved -L
{pkgs}:
pkgs.testers.nixosTest {
  name = "rust-rung1-resolved";
  ...
  testScript = ''
    ...
    machine.succeed("systemctl cat systemd-resolved.service | grep -q rust-systemd")
