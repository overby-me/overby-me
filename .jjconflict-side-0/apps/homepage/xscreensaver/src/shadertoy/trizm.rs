//! `trizm`, one of the Shadertoy savers.
//!
//! The program itself is `glsl/trizm.glsl`, vendored from upstream with
...
static VARIANTS: [Variant; 1] = [Variant {
    common: "",
    passes: &[include_str!("../../glsl/trizm.glsl")],
}];
...
pub static DEF: ShadertoyDef = ShadertoyDef {
    def: SaverDef {
        ...
        about: About {
            ...
            year: "2025",
            video: Some("https://www.youtube.com/watch?v=ejXezvNZKjA"),
            blurb: "Neon cyber circuit-board-like triangle waves.",
        },
    },
    variants: &VARIANTS,
};
