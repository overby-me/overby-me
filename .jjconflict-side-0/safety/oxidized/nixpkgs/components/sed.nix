...
# on it.
#
# oxidized-sed is our own implementation that supports all common delimiters
...
mkComponent {
  ...
  replacement = pkgs.oxidized-sed;
  status = status.available;
  source = source.repo;
  phase = 2;
  description = "Stream editor for filtering and transforming text";
  notes = "Using oxidized-sed from safety/oxidized/sed — GNU-compatible with all delimiter support";
}
