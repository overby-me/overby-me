{
  ...
  checks = let
    testNames = [
      ...
      "build-update-repo-default-branch"
      "build-update-repo-missing-args"
      "build-update-repo-redirect"
      "build-update-repo-title"
      "config-list"
      "config-set-get"
      "config-unset"
      "config-user"
      "config-user-path"
      "complete-lists-commands"
      "document-local-store"
      "permission-local-store"
    ...
    vmTestNames = [
      ...
      "override-socket-wayland"
      "override-device-dri"
      "override-filesystem-home"
      "override-persist"
      "override-nofilesystem-home"
      "override-nofilesystem-host"
      "override-nofilesystem-host-reset"
      "override-allow-disallow"
      "override-bus-session"
      "override-bus-system"
      "one-dir-commands"
      "config-languages-star"
      "config-unset"
      "history-install-uninstall"
      "run-cve-2024-32462"
      "seccomp-filter"
      "seccomp-devel"
      "remote-ls"
      ...
      "build-update-repo-default-branch"
      "update-from-remote"
      "bundle-update-as-bundle"
      "bundle-update"
      "persist-symlink-escape"
      "persist-path-traversal"
      "no-setuid"
      "no-world-writable"
      "repair-missing-file"
      "repair-no-problems"
      ...
      "extension-mount"
      "extension-unmask"
      "metadata-hidden-perms"
      "metadata-invalid"
      "metadata-no-xametadata"
      "metadata-mismatch"
      "info-show-commit"
      "info-show-location"
      "info-show-runtime"
