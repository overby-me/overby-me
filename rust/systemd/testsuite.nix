...
in
  pkgs.testers.nixosTest {
    ...
    testScript = ''
      ...
      test_cmd = (
          f"cd {units_dir} && "
          "export TEST_SKIP_TESTCASES='testcase_hierarchical_slice_dropins testcase_transient_slice_dropins testcase_transient_service_dropins testcase_template_dropins' && "
