...
in {
  checks = {
    ...
    llvm-upstream-verifier = pkgs: upstreamCheck pkgs "Verifier" 288 0;
    ...
    llvm-opt-differential = pkgs: differentialCheck pkgs "Assembler" 143;
    llvm-opt-differential-feature = pkgs: differentialCheck pkgs "Feature" 53;
