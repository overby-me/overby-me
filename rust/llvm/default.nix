...
in {
  checks = {
    ...
    llvm-opt-differential = pkgs: differentialCheck pkgs "Assembler" 169;
    llvm-opt-differential-feature = pkgs: differentialCheck pkgs "Feature" 60;
    llvm-opt-differential-linker = pkgs: differentialCheck pkgs "Linker" 189;
    llvm-opt-differential-other = pkgs: differentialCheck pkgs "Other" 133;
