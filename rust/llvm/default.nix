...
in {
  checks = {
    ...
    llvm-upstream-assembler = pkgs: upstreamCheck pkgs "Assembler" 453 12;
    llvm-upstream-verifier = pkgs: upstreamCheck pkgs "Verifier" 287 2;
    ...
    llvm-tree-transforms = pkgs: treeCheck pkgs "Transforms" 10102;
  };
