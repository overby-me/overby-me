...
in {
  checks = {
    ...
    llvm-upstream-assembler = pkgs: upstreamCheck pkgs "Assembler" 482 0;
    llvm-upstream-verifier = pkgs: upstreamCheck pkgs "Verifier" 325 0;
    ...
    llvm-opt-differential = pkgs: differentialCheck pkgs "Assembler" 215;
