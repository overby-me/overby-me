...
# nothing in a clone. This builds from plain nixpkgs instead.
{
  ...
  outputs = {
    ...
    cargoToml = builtins.fromTOML (builtins.readFile ./h26xtoav1/Cargo.toml);
    package = cargoToml.package or {};
    pname = package.name or "rust-h26xtoav1";
