//! The shapes `glsnake` folds itself into, from upstream's `glsnake.c`.
//!
...
pub const MODELS: &[(&str, &str)] = &[
    ...
    ("begging dog", "ZRRRPLRZRLPRRZLPLRPRLPLZ"),
    ("swan", "ZPZZZLZLZZRPLZZLPRZZLZLZ"),
    ...
    ("PictureComingSoon", "LLZRLPRRPRLPLRPRRPRLZRRZ"),
