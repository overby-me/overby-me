...
pub fn icon_url(icon: &str) -> String {
    match icon {
        ...
        "pronouns.avif" => asset!("/assets/icons/pronouns.avif").to_string(),
        "smol.avif" => asset!("/assets/icons/smol.avif").to_string(),
        "sidetrail.avif" => asset!("/assets/icons/sidetrail.avif").to_string(),
