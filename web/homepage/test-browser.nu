...
def main [
    ...
    let slugs = if $all {
        ...
        [alienbeacon batteredplanet bestill bubblecolors darktransit downfall
         ...
         universeball
         antinspect atunnel beats blinkbox blocktube boing bubble3d cage cityflow cube21 cubenetic cubestack cubestorm cubetwist cubicgrid dangerball discoball energystream gears glblur glknots glschool gravitywell hexstrut hextrail hypnowheel
         kaleidocycle lockward menger moebiusgears noof pinion pulsar quasicrystal raverhoop rubikblocks sierpinski3d splodesic stairs stonerview surfaces voronoi]
    } else if $slug != null {
        [$slug]
    } else {
