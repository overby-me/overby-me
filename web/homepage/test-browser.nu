...
def main [
    ...
    let slugs = if $all {
        ...
        [alienbeacon batteredplanet bestill bubblecolors darktransit downfall
         ...
         universeball
         antinspect beats blinkbox blocktube boing cityflow cube21 cubenetic cubestack cubestorm cubetwist cubicgrid dangerball discoball energystream glknots glschool gravitywell hexstrut hextrail hypnowheel
