...
def main [
    ...
    let slugs = if $all {
        ...
        [alienbeacon batteredplanet bestill bubblecolors darktransit downfall
         ...
         universeball
         antinspect atunnel beats blinkbox blocktube boing bubble3d cage cityflow cube21 cubenetic cubestack cubestorm cubetwist cubicgrid dangerball discoball energystream gears glknots glschool gravitywell hexstrut hextrail hypnowheel
